...
def test_compute_histogram_counts_bins_for_8bit_samples():
    from ce_scheme3.reference_model import compute_histogram
...
def test_clip_and_redistribute_preserves_total_count():
    from ce_scheme3.reference_model import clip_and_redistribute
...
def test_generate_lut_returns_monotonic_full_range_mapping():
    from ce_scheme3.reference_model import generate_lut_from_histogram
...
def test_model_process_frame_returns_smoothed_lut_and_mapped_samples():
    from ce_scheme3.reference_model import ContrastReferenceModel
