...
def test_build_starter_test_images_creates_manifest_and_eval_subset(tmp_path: Path):
    from ce_scheme3.starter_test_images import StarterDatasetConfig, build_starter_test_images
...
def test_starter_test_images_include_requested_ramps_and_color_bars():
    from ce_scheme3.starter_test_images import STARTER_IMAGE_SPECS
