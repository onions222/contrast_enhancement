...
- Python 浮点 golden：`src/ddic_ce_float/discrete_scene_gain.py`
- MATLAB 硬件运行时模型：`matlab/ce_hw_control_update.m`、`matlab/ce_hw_datapath.m`
...
本节对应 Python golden：`src/ddic_ce_float/discrete_scene_gain.py`。
...
- `matlab/ce_hw_control_update.m`
- `matlab/ce_hw_datapath.m`
